...
import { applyProfile, cloneProfile, createProfile, deleteProfile, editProfile, exportProfile, importProfile, refreshExtensionList, initSyncProfile, uploadProfile, downloadProfile } from "./commands";
...
export async function activate(ctx: vscode.ExtensionContext) {
  ...
  ctx.subscriptions.push(
    ...
    vscode.commands.registerCommand("vscode-extension-profiles.Init" as CommandType, () => initSyncProfile(ctx)),
    vscode.commands.registerCommand("vscode-extension-profiles.Upload" as CommandType, () => uploadProfile(ctx)),
    vscode.commands.registerCommand("vscode-extension-profiles.Download" as CommandType, () => downloadProfile(ctx)),
